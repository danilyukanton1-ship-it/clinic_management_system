...
from app.users.schemas.specialization import SpecializationCreateSchema, SpecializationUpdateSchema
...
class SpecializationRepository:
    ...
    async def update_specialization(self, specialization: Specialization, data: SpecializationUpdateSchema) -> Specialization:
    ...
    async def create_specialization(self, data: SpecializationCreateSchema) -> Specialization:

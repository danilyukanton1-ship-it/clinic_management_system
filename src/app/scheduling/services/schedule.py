...
class ScheduleService:
    ...
    async def get_all_schedule_by_doctor_id(self, doctor_id: int) -> list[ScheduleResponseSchema]:
    ...
    async def create(self, data: ScheduleCreateSchema) -> ScheduleResponseSchema:
        async with self.uow:
            ...
            if await self.uow.schedules.if_exists(doctor_id=data.doctor_id, weekday=data.weekday):

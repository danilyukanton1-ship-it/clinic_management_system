...
class PrescriptionItemService:
    ...
    async def get_by_id(
        ...
        prescription_item = await self.uow.prescription_items.get_prescription_item_by_id(
    ...
    async def update(
        ...
        async with self.uow:
            ...
            updated_prescription_item = await self.uow.prescription_items.update_prescription_item(
                prescription_item=prescription_item,
                data=data
            )
            return PrescriptionItemResponseSchema.model_validate(updated_prescription_item)

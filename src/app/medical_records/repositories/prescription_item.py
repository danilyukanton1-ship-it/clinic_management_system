...
class PrescriptionItemRepository:
    ...
    async def get_prescription_items_by_prescription_id(
    ...
    async def update_prescription_item(
        self, prescription_item: PrescriptionItem, data: PrescriptionItemUpdateSchema
    ) -> PrescriptionItem:
    ...
    async def delete_prescription_item(
        self, prescription_item: PrescriptionItem
    ) -> None:
